...
## First start ever
* ```npm run downloadData``` - This download swapi data into local jons file
* ```npm start```

## Other Starts
```npm start``` is enough. Whenever you want to update your data, do a ```npm run downloadData``` and restart the server.
