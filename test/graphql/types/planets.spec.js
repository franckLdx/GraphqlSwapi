...
describe('Planets tests suite', function() {
	...
	describe('Planets by name test suite', function() {
		it('Should get a planet based on his name', function() {
		...
		it('Should get a planet based on an extract of his name', function() {
	...
	describe('Related types should be in the response', function() {
		...
		it('Residents should be in the response', function() {
